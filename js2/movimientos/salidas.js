...
function _crearFilaSalida() {
    ...
    tr.innerHTML = `
        ...
        <td>
            <select class="form-select form-select-sm sal-unidad">
                ${_opcionesHTMLSalida(_unidSalida)}
            </select>
        </td>
        <td>
            <select class="form-select form-select-sm sal-presentacion">
                ${_opcionesHTMLSalida(_presSalida)}
            </select>
        </td>
    ...
    // Al cambiar lote → mostrar stock disponible
...
function _recolectarDetallesSalida() {
    return [...document.querySelectorAll('#tbodyDetallesSalida tr')]
        .map(fila => ({
            ...
            unidad_id:       fila.querySelector('.sal-unidad').value,
            presentacion_id: fila.querySelector('.sal-presentacion').value,
